        ...
        <div class="clearfix wrapper main_content_area">
            ...
            <div class="clearfix main_content floatleft">
                ...
                <div class="clearfix content">
                	<div class="content_title2"><h2>404 Error!</h2></div>
                    <div class="single_work_page clearfix">
                        <div class="work_single_page_feature"><img src="<?php echo base_url().'assets/images/404-error.jpg'; ?>" alt="404 Error" /></div>                                                
                    </div>
